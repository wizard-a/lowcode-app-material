import ColorfulButtonMeta from '/Users/qiaojie/Code/github.com/jiechud/lowcode-app-material/lowcode/colorful-button/meta'
import ColorfulInputMeta from '/Users/qiaojie/Code/github.com/jiechud/lowcode-app-material/lowcode/colorful-input/meta'
import MyInputMeta from '/Users/qiaojie/Code/github.com/jiechud/lowcode-app-material/lowcode/my-input/meta'
...
function fillRealVersion(meta, packageName = 'lowcode-app-material', version = '0.1.1', basicLibraryVersion={"@alifd/next":"1.25.23","@alifd/meet":"2.6.3","antd":"4.17.3"}) {
  if (!meta || !version) {
    return meta;
  }
  const { npm } = meta;
...
const componentMetas = [ColorfulButtonMeta,ColorfulInputMeta,MyInputMeta];
const components = [];
const npmInfo = {};
...
if (!execCompile) {
  window.LowcodeAppMaterialMeta = { components, componentList };
}